# Workshop: Java Fundamentals 1 (Calculator Application)
...
- Share the project on GitHub to record your activity for this workshop.
- The calculator should support addition, subtraction, multiplication, and division operations.  
- Users should be able to enter the numbers and the operator to perform the desired operation.
- The program should continue running until the user chooses to end it. After each operation,  
  the user should have the option to perform another calculation or exit the program.
...
- Add advance math operations.
- Implement a simple GUI version of the calculator using **Swing** or **JavaFX**.
